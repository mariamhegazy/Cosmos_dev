...
# from ours.autoregressive.cosmos_video2world import (
#     CosmosConfigVideo2World5B,
#     CosmosConfigVideo2World13B,
#     CosmosVideo2WorldModel,
# )

from ours.autoregressive.video2world_dataset import CosmosVideo2WorldDataModule
...
def main(args):
    ...
    llm.api.train(
        ...
        log=nl.NeMoLogger(wandb=(WandbLogger(project=os.getenv("WANDB_PROJECT"), name=os.getenv("WANDB_RUN_ID")) if "WANDB_API_KEY" in os.environ else None), log_dir=args.log_dir),
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_epochs", default=1000, type=int, help="Max number of epochs")
