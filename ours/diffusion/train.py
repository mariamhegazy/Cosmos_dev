...
from ours.diffusion.datamodule import DiTDataModule
...
#     DiTXLConfig,
# )
from ours.diffusion.models import (
    DiT7BConfig,
    DiTConfig,
    DiTLConfig,
    DiTLlama5BConfig,
...
@run.cli.factory
@run.autoconvert
def videofolder_datamodule(global_batch:int=1) -> pl.LightningDataModule:
    data_module = DiTDataModule(seq_length=21760, micro_batch_size=1, global_batch_size=global_batch, num_val_samples=1)
    return data_module
